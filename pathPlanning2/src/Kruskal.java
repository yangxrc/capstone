...
public class Kruskal {
    public HashSet nodes[];               // Array of connected components
    public TreeSet allEdges;              // Priority queue of Edge objects
    public Vector allNewEdges;            // Edges in Minimal-Spanning Tree
    ...
    public void AddToAllEdges(int from, int to, int cost){
    ...
    public boolean nodesAreInDifferentSets(int a, int b) {
